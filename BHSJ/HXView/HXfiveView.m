...
- (instancetype)initWithFrame:(CGRect)frame
{
    if ([super initWithFrame:frame]) {
        ...
        self.imageV.image = [UIImage imageNamed:@"4-户型鉴赏-1楼层/5#楼层平面图.png"];
        ...
        self.onebtn.frame  = CGRectMake(100, 350, 100, 100);
        ...
        self.secbtn.frame  = CGRectMake(340, 350, 100, 100);
